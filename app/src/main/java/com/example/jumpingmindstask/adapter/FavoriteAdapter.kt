...
import coil.load
import com.example.jumpingmindstask.databinding.FavoriteCardBinding
import com.example.jumpingmindstask.databinding.HomeCardBinding
import com.example.jumpingmindstask.model.DogsDataItem


class FavoriteAdapter : ListAdapter<DogsDataItem, FavoriteAdapter.ViewHolder>(DogsComparator()) {
    ...
    inner class ViewHolder(private val binding: FavoriteCardBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
